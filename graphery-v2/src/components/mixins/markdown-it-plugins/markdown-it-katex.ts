...
export default function math_plugin(md: MarkdownIt, options: KatexOptions) {
    ...
    // set KaTeX as the renderer for markdown-it-simple math
    function katexInline(tex: string) {
    ...
    function inlineRenderer(tokens: Token[], idx: number) {
    ...
    function blockRenderer(tokens: Token[], idx: number) {
